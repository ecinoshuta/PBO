...
//        btnCreatePanel.addActionListener((ActionEvent e) -> {
//            if (tfGaji.getText().equals("") ) {
//                JOptionPane.showMessageDialog(null, "Field tidak boleh kosong");
//            } else {
//                long Gajipokok, Jamlembur, Tunjangan, Pajak, Total;
//                Gajipokok = Long.valueOf(tfGaji.getText());
//                Jamlembur = Long.valueOf(tfJam.getText());
...
//                String Posisi = (String) cmbPosisi.getSelectedItem();
//                String Alamat = tfAlamat.getText();
//                String Nohp = tfHp.getText();
//
//                this.insertPegawai(Idkaryawan, Nama, Posisi, Alamat, Nohp, Gajipokok, Jamlembur, Tunjangan, Pajak, Total);
//
//
//            }
//        });
